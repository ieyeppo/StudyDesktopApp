...
namespace ListViewApp
{
    public partial class FrmMain : Form
    {
        ...
        private void FrmMain_Load(object sender, EventArgs e)
        {
            ...
            itemXbox.SubItems.Add("1,400,000");

            LsvProducts.Items.Add(itemSwitch);
            LsvProducts.Items.Add(itemDs);
            LsvProducts.Items.Add(itemPs);
            LsvProducts.Items.Add(itemWii);
            LsvProducts.Items.Add(itemXbox);
        }

        private void RdbDetail_CheckedChanged(object sender, EventArgs e)
        {
            if (RdbDetail.Checked) LsvProducts.View = View.Details;
        }
